	...
	if($i<$bigitems) {?>
		<div class="jazin-contentwrap">
			<div class="jazin-content clearfix" >			
					<a href="<?php echo $news->link; ?>" <?php if($showtooltip){?>title='<?php echo trim(strip_tags($news->title), '"'); ?>::<?php echo htmlspecialchars($news->bigimage.$news->introtext)?>'<?php }?> class="jazin-content-inner <?php if($showtooltip){?>editlinktip hasTip<?php }?>">
					...
					<?php if ($showhlreadmore) {?><a href="<?php echo $news->link;?>" class="readmore">
					<?php echo JText::_('JAFP_READ_MORE'); ?></a><?php } ?>
