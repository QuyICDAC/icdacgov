...
/**
 * ------------------------------------------------------------------------
 * JA Teline IV Template for Joomla 2.5 & 3.0
 * ------------------------------------------------------------------------
                    ...
                    <div class="ja-zinfp-featured-wrap column">
                        <div class="ja-zinfp-featured-border">
                            <div class="ja-zinfp-featured clearfix">
                                ...
                                if ($i < $bigitems) {
                                ?>
                                <div class="ja-zincontent-wrap <?php if ($i == 0) {
                                    echo 'active show';
                                } else {
                                    echo 'hide';
                                } ?>">
                                    <div class="ja-zincontent clearfix">
                                        <?php if ($bigshowimage && $news->bigimage) { ?>
                                            <div
                                                class="ja-zincontent-img clearfix" <?php if ($align != 0) { ?> style="float:<?php echo $align; ?>" <?php } ?>>
                                                <?php if ($bigshowimage) echo $news->bigimage ?>
                                            </div>
                                        <?php } ?>
                                        <h2 class="ja-zintitle">
                                            <a href="<?php echo $news->link; ?>"
                                               title="<?php echo strip_tags($news->title); ?>">
                                                <?php echo $news->title; ?>
                                            </a>
                                        </h2>
                                        ...
                                        <?php if ($showhlreadmore) { ?>
                                            <p class="readmore">
                                                <a href="<?php echo $news->link ?>" class="readon"
                                                   title="<?php echo JText::_('JAFP_READ_MORE'); ?>"><span><?php echo JText::_('JAFP_READ_MORE'); ?></span></a>
                                            </p>
                                        <?php } ?>
                                    </div>
                                </div>

                         <?php if ($i == $bigitems - 1 || $i == count($rows) -1){ ?>
                            </div>
                        ...
                        <div class="ja-zinfp-normal clearfix">
                            ...
                            <?php } else { ?>
                                <div class="ja-zincontent-wrap">
                                    <div
                                        class="ja-zincontent clearfix <?php if ($showtooltip) { ?>editlinktip jahasTip<?php } ?>"
                                        <?php if ($showtooltip){ ?>title="<?php echo trim(strip_tags($news->title), '"'); ?>::<?php echo htmlspecialchars($news->smallimage . $news->bigintrotext) ?>"<?php } ?>>
                                        <?php if ($smallshowimage && $news->smallimage) { ?>
                                            <div
                                                class="ja-zincontent-img <?php echo $align; ?> " <?php if ($align != 0) { ?> style="float:<?php echo $align; ?>" <?php } ?>>
