...
<div id="k2Container" class="itemInterView ja-itemView itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemHeader">
	  	...
	  	<?php endif; ?>
			...
			<span class="itemEditLink">
				<a class="modal" rel="{handler:'iframe',size:{x:990,y:550}}" href="<?php echo $this->item->editLink; ?>">
					<i title="<?php echo JText::_('K2_EDIT_ITEM'); ?>" class="icon-edit"></i>
				</a>
			</span>
			<?php endif; ?>
	  </h2>
	  <?php endif; ?>
		...
		<?php if($this->item->params->get('itemCategory') || $this->item->params->get('itemDateCreated') || $this->item->params->get('itemAuthor')): ?>
		...
		<ul>
			...
			<li>
				<a class="itemEmailLink" rel="nofollow" href="<?php echo $this->item->emailLink; ?>" onclick="window.open(this.href,'emailWindow','width=400,height=350,location=no,menubar=no,resizable=no,scrollbars=no'); return false;">
					<i class="icon-envelope" title="<?php echo JText::_('K2_EMAIL'); ?>"></i>
				</a>
			</li>
			<?php endif; ?>
