...
<div id="k2Container" class="latestView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="latestItemsPrimary">
		<?php foreach($this->blocks as $key=>$block): ?>
		
		<?php
		// Define a CSS class for the last container on each row
		if((($key+1)%($this->params->get('latestItemsCols'))==0))
			$lastContainer= ' latestItemsContainerLast';
		else
			$lastContainer='';
		?>
		
		<div class="latestItemsContainer<?php echo $lastContainer; ?>" style="width:<?php echo number_format(100/$this->params->get('latestItemsCols'), 1); ?>%;">
			<div class="latestItemsView">
