		...
		<li class="clearfix">
			...
			<br/>
				...
				<span class="post-date">	
					<?php if ($showcreater) : ?>
				<span class="createby"><?php echo JText::_('TPL_ARTICLE_CATEGORY_BY'); ?><span><?php echo $item->creater;?></span></span>
			<?php endif;?>				
			
			<?php if (isset($item->date)) :?>
				<span class="createdate"><?php echo JText::_('TPL_ARTICLE_CATEGORY_POST').': '; echo JHTML::_('date', $item->date, JText::_('DATE_FORMAT_LC3')); ?></span>
			<?php endif;?>
			</span>
